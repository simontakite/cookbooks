...
class authentication {
    ...
    public function checkForAuthentication()
    {
    	...
    	{
    		$this->postAuthenticate( PeacockCarterFrameworkRegistry::getObject('db')->sanitizeData( $_POST['ecomf_auth_user'] ), md5( $_POST['ecomf_auth_pass'] ) );
    	}
	     //echo $this->userID;
    }
    ...
    private function sessionAuthenticate( $uid )
    {
    	...
    	PeacockCarterFrameworkRegistry::getObject('db')->executeQuery( $sql );
    	if( PeacockCarterFrameworkRegistry::getObject('db')->numRows() == 1 )
    	{
