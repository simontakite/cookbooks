...
show_time()
{
   dialog --backtitle "$WINTITLE" --title "DATE & TIME" \
...
show_cal()
{
   dialog --backtitle "$WINTITLE" --title "CALENDAR" \
   --msgbox "`cal`" 12 25
}
...
deletefile()
{
   ...
   dialog --backtitle "$WINTITLE" --title "Directory Path" \
...
\nFiles under directory $dirname:" 18 60 12 \
     ...
     dialog --backtitle "$WINTITLE" --title "Select File to Delete" \
   ...
   case $rtval in
       ...
       0) dialog --backtitle "$WINTITLE" --title "ARE YOU SURE" \
...
# Dialog utility to display options list
    ...
    dialog --clear --backtitle "$WINTITLE" --title "MAIN MENU" \
