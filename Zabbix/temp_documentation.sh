...
# #############################################################################
    ...
    PURPOSE_="  This script semi-automates the creation of the templates documentation on gitlab"
...
function authors {
	...
	echo -e "\n"
	echo "Simon Takite"
	echo "(simont |at| uninett |dot| no)"
	echo -e "\n"
	echo "Rune Myrhaug"
	echo "(rune |at| uninett |dot| no)"
	echo -e "\n"
	echo "Bjørn Villa"
	echo "(bjorn |at| uninett |dot| no)"
	}
