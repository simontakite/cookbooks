...
# The difference between the SCR_5004_$version_NUAC-Sauvegarde-Volumes-EBS.sh script is that the logical volume is backuep to a .img.gz file. 
# It is meant to be used in order to have 
