...
'''
a simple python script that sends a dhcp discover packet and recieves the dhcp offer
that contains a suggested ip address, gateway, dns servers and displays them.
'''
...
if __name__ == '__main__':
    ...
    try:
        dhcps.bind(('', 1120))  # we want to send from port 68
